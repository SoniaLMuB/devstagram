...
<div class="bg-blue-50 flex items-center justify-center flex-col min-h-screen  bg-background">
    <!-- main card -->
    <div class="bg-[#F4F5FA] p-10 rounded-xl">
        <!-- Frase de bienvenida-->
        <div class="flex flex-col justify-center items-center text-center">
            <div class="font-bold text-gray-700 text-center text-3xl mb-10">
                ¡Bienvenido a nuestro espacio digital, donde <br>las conexiones cobran vida!
            </div>
        </div>
        ...
        <div class="flex flex-col md:flex-row space-x-0 md:space-x-8 space-y-12  md:space-y-0 justify-center items-center mt-10">
            <div class="bg-[#FFFBEC] rounded-xl">
                <div class="flex flex-col p-8 rounded-xl bg-white shadow-xl translate-x-4 translate-y-4 w-96 md:w-auto">
                    ...
                    <div class="mt-3 font-semibold text-lg text-center">Explora, interactúa y haz conexiones <br>significativas en Devstagram.<br></div>
                    <div class="mt-3 font-semibold text-lg text-center text-white">.</div>
                </div>
            </div>
            <!--Frase del segundo Card-->
            <div class="bg-[#ECEEFF] rounded-xl">
                <div class="flex flex-col p-8 rounded-xl bg-white shadow-xl translate-x-4 translate-y-4 w-96 md:w-auto">
                    <div class="mt-3 font-semibold text-lg text-center">Encuentra inspiración, diversión y amistades <br>en un espacio digital donde las conexiones<br> significativas   se hacen realidad</div>
                </div>
            </div>
        </div>
        <br>
        ...
        <div class="flex flex-col justify-center items-center text-center">
            <div id="whoobe-3fery" class="w-full md:w-64 justify-center items-center bg-white shadow-lg rounded-lg flex flex-col">
                <img src="{{asset('imgs/Redes-sociales.gif')}}" alt="Imagen registro de usuarios" class="w-full h-auto object-cover rounded-t-lg" id="whoobe-ixxe5">
            </div>
        </div>

        <!--Botón que manda a la pagina de registrarse -->
